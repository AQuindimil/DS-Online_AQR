...
app = Flask(__name__)
app.config["DEBUG"] = True #activamos el depurador

@app.route('/', methods=['GET']) #llamada al decorador
def home(): #Home nos da la vienvenida
    return """ 
    <h1>The Bridge Distant Reading Archive</h1>
